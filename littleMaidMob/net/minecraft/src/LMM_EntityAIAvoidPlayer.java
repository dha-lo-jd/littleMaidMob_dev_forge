...
public class LMM_EntityAIAvoidPlayer extends EntityAIBase implements LMM_IEntityAI {
	...
	public boolean shouldExecute() {
		...
		// 移動先を策定
		Vec3 vec3d = RandomPositionGenerator.findRandomTargetBlockAwayFrom(theMaid, minDist, 7,
				Vec3.createVectorHelper(theMaster.posX, theMaster.posY, theMaster.posZ));
